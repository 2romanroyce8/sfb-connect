...
const FAQS = [
  ...
  },
  {
    ...
    a: "Both. Plans start at $19.99/month, or save 20% with annual billing. Grow and Managed tiers are for businesses that want SFB Connects to actively do the work or fully manage it for them. Book a demo and we'll help you pick the right one.",
    color: "#FF8A3D",
  },
  {
